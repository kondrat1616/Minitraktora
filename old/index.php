		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 col-sm-3 col-xs-6 header-city">
					<p><i></i>Москва</p>
					<a href="#openMenu">город доставки</a>
				</div>
...
<div id="openMenu" class="wrap-regions">
	<div>
		<div class="container">
	...
	<div class="container section-1">
		<div class="row">
			<div class="col-md-12 section-title section-title-1">
				<h2>закажите шиномонтажный станок<br/><span>Trommelberg 1810E</span><br><span>по цене завода</span> изготовителя с доставкой<br><span>от 2 до 14 дней с оптового склада</span></h2>
			</div>
		</div>
		<div class="row">
				...
				<div class="section-1-form-wrap">
				  ...
				  <input type="hidden" name="subject" value="Узнай цены! оставь заявку">
				 	 ...
				 	 <div class="wrap-input-telephone">
				  		<input class="input-text input-phone" type="text" name="phone" placeholder="Телефон">
				 	 </div>
				  	...
				  	<div class="wrap-select">
						...
						<option value="1_variant">Вариант 1</option>
						<option value="2_variant">Вариант 2</option>
						<option value="3_variant">Вариант 3</option>
				  		</select>
				  	</div>
					...
					<div class="form-catalog-wrap">
						...
						<div class="form-catalog">
							 <form method="post" action="sender.php" class="sform">
								...
								<input class="input-text input-phone input-string-form"  type="text" name="phone" placeholder="Телефон">
...
для шиномонтажа <span>с ценами производителя</span></h4>
					...
					<div class="wrap-input-name-price">
				  	...
				  	<div class="wrap-input-telephone-price">
				  		<input class="input-text input-phone input-price"  type="text" name="phone" placeholder="Телефон">
				 	 </div>
						...
						<div class="wrap-calc">
							 <form method="post" action="sender.php" class="sform">
							  <input type="hidden" name="subject" value="Калькулятор">
								<fieldset>
									<input type="checkbox" name="stanok" value="shinomontazhnyj" id="TireCheckBox">
									...
									<div class="calc-col-3">
										...
										<select class="firstBoxItems" name="moshchnost" disabled>
											<option value="075" selected="selected">0,75 - 1,1 Вт</option>
											<option value="moshvar2">Вариант 1</option>
											<option value="moshvar3">Вариант 2</option>
											<option value="moshvar4">Вариант 3</option>
				  						</select>
									</div>
									<div class="calc-col-4">
										<p>диаметр диска</p>
											<select class="firstBoxItems" name="diameter" disabled>
											<option value="d21" selected="selected">21&lsquo;&rsquo;</option>
											<option value="dvar2">Вариант 1</option>
											<option value="dvar3">Вариант 2</option>
											<option value="dvar4">Вариант 3</option>
				  						</select>
									</div>
								...
								<fieldset>
									<input type="checkbox" name="balansirovochnyj" value="balansirovochnyj" id="BalanceCheckBox">
									...
									<div class="calc-col-5">
										...
										<option value="type2">Вариант 1</option>
										<option value="type3">Вариант 2</option>
										<option value="type4">Вариант 3</option>
				  					</select>
									</div>
								...
								<fieldset class="last-fieldset">
									<input type="checkbox" name="kompressor" value="kompressor" id="stanok3">
									<label class="label-style-1" for="stanok3">Компрессор поршневой</label>
									<br/>
								</fieldset>
								<div class="wrap-form-btn-calc">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="wrap-form-call">
							<p>позвоните<i class="fa fa-phone fa-1x"></i><span> 8 800 2000 600</span></p>
							 ...
							 <input type="hidden" name="subject" value="Заявка на звонок">
								<div class="wrap-input-name-call">
				  				...
				  				<div class="wrap-input-telephone-call">
				  					<input class="input-text input-phone input-call"  type="text" name="phone" placeholder="Телефон">
				 	 			</div>
				...
				<div class="row">
					...
					<div class="wrap-input-name-credit">
				  	...
				  	<div class="wrap-input-telephone-credit">
				  		<input class="input-text input-phone-crd input-price input-credit"  type="text" name="phone" placeholder="Телефон">
				 	 </div>
...
<input type="text" name="phone" class="phone-input input-text" placeholder="Ваш телефон">
...
<!-- Modal Ok-->
<div id="myModalOk" class="modal fade" tabindex="-1">
<div class="modal-dialog text-center">
<div class="modal-content">
<div class="modal-header"><button class="close" type="button" data-dismiss="modal">×</button>
...
function viewdiv() {
	...
	for(var i = 0;i<el.length;i++)
		...
		<script async defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB9wcj4Sd6cMNpRJyKozElEXvpj3iLP8os&callback=initMap">
    </script>
        <script>
			var silver = [
    {
    ...
    },
    {
      ...
      function initMap() {
		 ...
		 var myLatLng = {lat: 53.6, lng: 79.75};
		
		  
//var image.src = placeholder_map.png;
        // Create a map object and specify the DOM element for display.
        var map = new google.maps.Map(document.getElementById('map'), {
		
          center: {lat: 53.6905946, lng:79.7553934},
          scrollwheel: false,
          zoom: 3,
		  //icon = image;
		
        });
		   var image = 'img/placeholder_map.png';
  var beachMarker = new google.maps.Marker({
    position: {lat: 53.6, lng: 79.75},
    map: map,
    icon: image,
	  title: 'test icon'
  });
