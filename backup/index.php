	...
	<div class="container section-1">
		<div class="row">
			<div class="col-md-12 section-title section-title-1">
				<h2>закажи <span>шиномонтажное оборудование</span><br><?php echo $brands_arr[$brand_id]["brandName"];?>&nbsp;<span>по ценам завода</span> изготовителя с доставкой<span> от 2 до 14 дней с оптового склада</span></h2>
			</div>
		</div>
		<div class="row">
